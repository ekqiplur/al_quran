...
import 'package:simple_quran/widget/quran_read.dart';
    ...
    return Scaffold(
      appBar: AppBar(
        title: Column(
          ...
          children: <Widget>[
            Text("Al-Qur'an"),
            Text('${data.name} - ${data.arab}', style: TextStyle(fontSize: 14, color: Colors.white70)),
          ],
        ),
      ),
      body: Container(
                ...
                if (snapshot.hasError) {
                  ...
                  return Consumer<QuranAyat>(
                    builder: (ctx, data, _) => ListView.builder(
                        ...
                        itemBuilder: (context, i) => QuranRead(
